      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="text-center animate-fade-up">
            ...
            <button className="bg-gradient-to-br from-black/40 via-[#403E43]/40 to-[#1EAEDB]/20 text-white px-12 py-4 rounded-full font-medium transition-all hover:bg-primary/90 hover:scale-105 mb-8 border border-white/10 backdrop-blur-md shadow-lg w-64">
              Discover Plans
            </button>
